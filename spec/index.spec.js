...
describe("Recipe tests", () => {
  ...
  it("can not be create", async () => {
    ...
    it("Can update recipes", async () => {
        ...
        const recipe = {id:5, title: "crenpe", type: "dessert", ingredient: "farime" };
        await RecipeModel.updateRecipes(recipe.id, recipe.title, recipe.ingredient, recipe.type)
    ...
    it("Can not update recipes", async () => {
        ...
        const recipe = {id:5000, title: "crenpe",ingredient: "farime", type: "dessert" };
        const updateRecipe = await RecipeModel.updateRecipes(recipe.id, recipe.title, recipe.ingredient, recipe.type)
